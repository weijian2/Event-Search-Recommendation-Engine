package external;
//since TicketMaster asked to use GeoPoint instead of latitude and longitude directly in request, I add this helper class to do GeoHash encoding. 
//The code here is copied from an simple implementation from http://developer-should-know.com/post/87283491372/geohash-encoding-and-decoding-algorithm.
