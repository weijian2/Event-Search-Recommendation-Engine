...
public class MySQLTableCreation {
	...
	public static void main(String[] args) {
		try {
			...
			// Step 3: insert data
			// Create a fake user, 3229c1097c00d497a0fd282d586be050 is actually the hashed password of 2222
			sql = "INSERT INTO users " + "VALUES (\"1111\", \"3229c1097c00d497a0fd282d586be050\", \"Daniel\", \"Li\")";
